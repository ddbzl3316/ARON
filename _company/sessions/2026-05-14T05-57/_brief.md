...
## 요약
시스템 자율 사이클을 수행하여 현재 가장 가치 있는 단일 작업을 결정하고 실행할 계획을 수립합니다.

## 분배
- **📱 영숙**: 회사 목표, 에이전트 개인 목표(_agents/{id}/goal.md), 최근 의사결정 및 메모리를 검토하여 현재 가장 가치 있는 단일 작업 1개를 결정하고, 이를 실행하기 위한 최적의 1~2명 에이전트를 지정하는 보고서를 작성하라
